...
declare_id!("FvbdeWoTjTpaS4G24Qwb2mTwWdRPryjWxwKALMB69bdF");

#[program]
pub mod mogate_giftcard_encrypt {
    use super::*;
    ...
    pub fn unwrap(ctx: Context<Unwrap>) -> Result<()> {
        ...
        require!(
            giftcard.backend == Backend::Encrypt as u8,
            GiftcardError::InvalidBackend
        );
    ...
    pub fn grant_confidential_permission_cpi<'info>(
        ...
        grant_confidential_permission(ctx, cpi_data, Some(Backend::Encrypt as u8))
    }
    ...
    pub fn encrypt_copy_giftcode_for_grantee(
        ...
        encrypt_copy_giftcode_for_grantee_impl(ctx, Some(Backend::Encrypt as u8))
    }
}
